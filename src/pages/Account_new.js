      ...
      <div style={styles.container}>
        ...
        <div style={styles.card}>
          ...
          <div style={styles.header}>
            <div style={styles.logo}>{currentTheme.emoji}</div>
            <h1 style={styles.title}>Digital Spot It!</h1>
            <p style={styles.subtitle}>Fast-paced visual matching game</p>
          </div>
          ...
          <div style={styles.content}>
            ...
            <div style={styles.rules}>
              ...
              <p style={styles.rulesText}>
                Find the one matching symbol between any two cards - there's always exactly one match! Be the first to spot and name it to win the card. ⚡️
              </p>
            </div>
